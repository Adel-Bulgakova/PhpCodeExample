	                ...
	                <div>
	                    <div class=\"page-title\">
	                        <div class=\"title_left\">
	                            <h3>Список трансляций, отсутствующих на медиасервере</h3>
	                        </div>
	                    </div>
	                        ...
	                        <div class=\"col-xs-12\">
	                            <div class=\"admin_panel\">
	                                <div class=\"admin_panel_content\">
	                                	<div>
		                                	<div class=\"clear\"></div>	
		                                    <table id=\"streams_excess\" class=\"table table-striped responsive-utilities jambo_table bulk_action\" width=\"100%\">
												<thead>
		                                            <tr class=\"headings\">
