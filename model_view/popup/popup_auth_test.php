...
if (mobile_test($_SERVER["HTTP_USER_AGENT"]) == 1) {
   $input_html = "<input type=\"text\" class=\"form-control form-control--mobile\" pattern=\"[0-9_-]{10}\" name=\"phone_number\" placeholder=\"(___) ___ __ __\"" . _ENTER_PHONE_NUMBER . "\" />";
} else {
    $input_html = "<input type=\"text\" class=\"form-control form-control--desktop\" name=\"phone_number\" placeholder=\"" . _ENTER_PHONE_NUMBER . "\" />";
}
